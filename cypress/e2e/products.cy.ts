describe('Product Page E2E Tests', () => {
  ...
  it('should filter products by category "Flowers"', () => {
    ...
    cy.wait(1000); // Wait for the filtering to complete
  ...
  it('should filter products by price range between $20 and $30', () => {
    ...
    cy.wait(1000); // Wait for the filtering to complete
    cy.get('.product-card').should('have.length', 1);  // Verify one product is displayed
  ...
  it('should sort products by price ascending', () => {
    ...
    cy.wait(1000); // Wait for the sorting to complete
